...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#030712] pt-32">
      ...
      <div className="relative z-10 max-w-[1450px] mx-auto px-8 grid lg:grid-cols-[0.85fr_1.15fr] gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-6 mt-14">
            ...
            <button className="px-10 py-5 rounded-2xl bg-gradient-to-r from-cyan-500 to-purple-500 text-lg font-semibold hover:scale-[1.03] transition duration-300 text-white shadow-2xl shadow-cyan-500/20">

              Request Enterprise Demo

            </button>

            <button className="px-10 py-5 rounded-2xl border border-white/10 bg-white/5 text-lg font-semibold hover:bg-white/10 transition duration-300 text-white">
        ...
        >
          ...
          <div className="rounded-[45px] border border-white/10 bg-white/[0.04] backdrop-blur-xl p-8 shadow-2xl">
            ...
            <div className="rounded-[40px] min-h-[420px] bg-gradient-to-br from-cyan-500/20 to-purple-500/20 border border-white/10 flex items-center justify-center relative overflow-hidden">

              {/* GLOW */}

              <div className="absolute w-[500px] h-[500px] rounded-full bg-cyan-500/20 blur-[120px]"></div>
